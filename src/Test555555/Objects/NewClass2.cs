...
namespace IIS.Test555555
{
    ...
    public class NewClass2 : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Test555555.NewClass1 fNewClass1;
        ...
        [PropertyStorage(new string[] {
                "NewClass1"})]
        [NotNull()]
        public virtual IIS.Test555555.NewClass1 NewClass1
        {
            get
            {
                ...
                IIS.Test555555.NewClass1 result = this.fNewClass1;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View NewClass2E
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("NewClass2E", typeof(IIS.Test555555.NewClass2));
                }
            }
            ...
            public static ICSSoft.STORMNET.View NewClass2L
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("NewClass2L", typeof(IIS.Test555555.NewClass2));
                }
            }
        }
    }
