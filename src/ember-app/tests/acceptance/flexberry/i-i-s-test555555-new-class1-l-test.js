...
moduleForAcceptance('[AGAT] Acceptance | i i s test555555 new class1 l');

test('testing i-i-s-test555555-new-class1-l', function(assert) {
  visit('/i-i-s-test555555-new-class1-l');
